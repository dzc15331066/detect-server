...
class Processor(Iface, TProcessor):
    ...
    def process_get_features(self, seqid, iprot, oprot):
        ...
        result = get_features_result()
        try:
            result.success = self._handler.get_features(args.jpg_img)
...
class get_features_args(object):
    ...
    def __init__(self, jpg_img=None,):
        self.jpg_img = jpg_img
    ...
    def write(self, oprot):
        ...
        if self.jpg_img is not None:
            oprot.writeFieldBegin('jpg_img', TType.STRING, 1)
            oprot.writeBinary(self.jpg_img)
            oprot.writeFieldEnd()
...
all_structs.append(get_features_args)
get_features_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'jpg_img', 'BINARY', None, ),  # 1
)
...
class get_features_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_features_result)
get_features_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [FeaturesResult, None], None, ),  # 0
)
